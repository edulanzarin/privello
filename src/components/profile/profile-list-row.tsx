  ...
  return (
    ...
    >
      ...
      <div className="relative h-28 w-20 shrink-0 bg-line sm:h-32 sm:w-24">
        ...
        <div className={cn(
          "absolute inset-x-0 bottom-0 flex items-center justify-center gap-1 py-0.5 text-2xs font-bold",
      ...
      <div className="flex min-w-0 flex-1 flex-col justify-between gap-1 p-3 sm:flex-row sm:items-center sm:p-4">
        <div>
          ...
          <p className="mt-0.5 text-2xs text-muted/50">@{profile.slug}</p>
        ...
        <div className="flex shrink-0 items-center gap-3">
          {profile.isVerified && (
            <span className="hidden items-center gap-1 text-2xs font-semibold uppercase tracking-wide text-success sm:flex">
