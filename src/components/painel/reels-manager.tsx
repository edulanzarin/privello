          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4">
            {reels.map((reel) => (
              <div key={reel.id} className="group relative aspect-[9/16] overflow-hidden rounded-xl bg-black ring-1 ring-black/[0.06]">
                <video
                  src={reel.url}
                  className="h-full w-full object-cover"muted
                  playsInline
                  preload="metadata"/>
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 bg-black/50 opacity-0 transition group-hover:opacity-100 rounded-xl">
                  ...
                  <div className="flex flex-col items-center gap-1.5">
                    <button
                      type="button"onClick={() => handleTogglePrivacy(reel.id)}
                      disabled={pending}
                    ...
                    <button
                      type="button"onClick={() => handleDelete(reel.id)}
                      disabled={pending}
      ...
      <div className="rounded-2xl border border-line bg-white p-5 space-y-5 shadow-sm lg:sticky lg:top-24 lg:self-start">
        ...
        {preview ? (
          <div className="relative aspect-[9/16] w-full overflow-hidden rounded-xl bg-black">
            ...
            <button
              type="button"onClick={clearPreview}
        ...
        <input
          ref={fileRef}
          type="file"accept="video/mp4,video/webm,video/quicktime"className="hidden"onChange={handleFileSelect}
        />
