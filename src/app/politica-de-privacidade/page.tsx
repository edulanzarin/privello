            ...
            <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
                ...
                <div className="mt-10 space-y-8 text-sm leading-relaxed text-foreground/80">
                    <Section n="1" title="Quem somos">
                        <p>
                            O <strong>Privello</strong> é uma plataforma digital operada por
                        ...
                        <p>
                            ...
                            entre em contato em <a href="mailto:contato.privello@gmail.com" className="underline">contato.privello@gmail.com</a>.
                        </p>
                    </Section>
                    ...
                    <Section n="2" title="Dados que coletamos">
                        ...
                        <ul className="ml-5 list-disc space-y-1">
                            <li><strong>Cliente:</strong> nome, e-mail, senha (hash bcrypt), avatar opcional, slug público.</li>
                            <li><strong>Provedor:</strong> nome, e-mail, senha (hash bcrypt), data de nascimento, cidade/bairro, telefone (WhatsApp opcional), foto de perfil, biografia, características físicas declaradas, valores cobrados, formas de pagamento aceitas, idiomas.</li>
                        </ul>

                        <h3 className="mt-6 mb-2 text-base font-medium text-foreground">
                            2.2. Dados de verificação de identidade (provedor)
                        </h3>
                        <ul className="ml-5 list-disc space-y-1">
                        ...
                        <p>
                            Estes dados têm <strong>tratamento restrito</strong> à equipe de
                        ...
                        <p>
                            Os dados de cartão de crédito ou meio de pagamento <strong>não são
                    ...
                    <Section n="3" title="Para que usamos seus dados">
                        <ul className="ml-5 list-disc space-y-1">
                            <li><strong>Funcionamento da plataforma:</strong> autenticar você, exibir perfis, processar buscas, registrar interações.</li>
                            <li><strong>Verificação:</strong> confirmar identidade dos provedores e prevenir fraudes.</li>
                            <li><strong>Pagamentos:</strong> integrar com o Mercado Pago e gerenciar a vigência de assinaturas.</li>
                            <li><strong>Comunicações transacionais:</strong> enviar e-mails de confirmação de cadastro, recuperação de senha, recibos e avisos sobre a conta.</li>
                            <li><strong>Moderação:</strong> revisar conteúdo reportado e aplicar políticas de uso.</li>
                            <li><strong>Segurança:</strong> proteger a plataforma contra abuso, ataques, fraudes e bots.</li>
                            <li><strong>Métricas agregadas:</strong> melhorar o produto a partir de estatísticas anônimas (sem identificação pessoal).</li>
                            <li><strong>Cumprimento legal:</strong> atender requisições da Justiça e órgãos competentes quando legalmente exigido.</li>
                        </ul>
                    </Section>

                    <Section n="4" title="Bases legais (LGPD art. 7º)">
                        <ul className="ml-5 list-disc space-y-1">
                            <li><strong>Execução de contrato</strong> (art. 7º, V): cadastro, pagamento, fornecimento do espaço de visibilidade.</li>
                            <li><strong>Consentimento</strong> (art. 7º, I): envio de comunicações não transacionais, cookies não essenciais.</li>
                            <li><strong>Legítimo interesse</strong> (art. 7º, IX): segurança, prevenção a fraude, métricas agregadas.</li>
                            <li><strong>Cumprimento de obrigação legal</strong> (art. 7º, II): atendimento a ordens judiciais, retenção fiscal de comprovantes de pagamento.</li>
                            <li><strong>Proteção da vida</strong> (art. 7º, IV): em situações de risco a usuário ou a terceiros.</li>
                        </ul>
                    </Section>
                    ...
                    <Section n="5" title="Compartilhamento com terceiros">
                        <p>
                            ...
                            necessários com os seguintes <strong>operadores</strong> (na acepção da
                        ...
                        <ul className="ml-5 list-disc space-y-1">
                            <li>
                                ...
                                <a className="underline" href="https://www.mercadopago.com.br/ajuda/privacy" target="_blank" rel="noreferrer">Política do Mercado Pago</a>.
                            </li>
                            <li>
                                <strong>Cloudflare R2</strong> (armazenamento de arquivos): fotos,
                            ...
                            <li>
                                <strong>Cloudflare</strong> (DNS e CDN): logs de acesso (IP,
                                user-agent), tráfego HTTP. Mesmos termos da Cloudflare DPA.
                            </li>
                            <li>
                                <strong>Railway</strong> (hospedagem da aplicação e banco
                                Postgres): processa todos os dados da aplicação em servidor
                                único na zona US East. Sob a Railway DPA.
                            </li>
                            <li>
                                <strong>Google LLC (Gmail SMTP)</strong> (envio de e-mails
                    ...
                    <Section n="6" title="Seus direitos (LGPD art. 18)">
                        <p>
                        ...
                        <ul className="ml-5 list-disc space-y-1">
                            <li><strong>Confirmação e acesso:</strong> saber se tratamos dados sobre você e receber uma cópia.</li>
                            ...
                            <li><strong>Portabilidade:</strong> receber seus dados em formato estruturado para enviar a outro fornecedor.</li>
                            <li><strong>Eliminação dos dados</strong> tratados sob consentimento.</li>
                            <li><strong>Informação sobre compartilhamento</strong> com órgãos públicos ou privados.</li>
                            <li><strong>Revogação do consentimento</strong>, quando for a base legal aplicável.</li>
                            <li><strong>Oposição</strong> a tratamento em desacordo com a LGPD.</li>
                        </ul>
                        <p>
                            Solicitações em <a href="mailto:contato.privello@gmail.com" className="underline">contato.privello@gmail.com</a>.
                            Confirmaremos sua identidade antes de processar requisições para
                            evitar acesso indevido por terceiros.
                        </p>
                    </Section>

                    <Section n="7" title="Retenção de dados">
                        <p>
                            Mantemos seus dados pelo tempo necessário às finalidades descritas
                            ou conforme exigido por lei.
                        </p>
                        <ul className="ml-5 list-disc space-y-1">
                            <li><strong>Conta ativa:</strong> enquanto a conta existir.</li>
                            <li><strong>Conta inativa (perfil sem renovação):</strong> mantida em estado oculto por até 12 meses para permitir reativação rápida.</li>
                            <li><strong>Conta encerrada por solicitação:</strong> dados pessoais identificáveis são deletados em até 30 dias, exceto registros mínimos exigidos por lei (notas fiscais, comprovantes de pagamento — retenção de 5 anos por exigência fiscal).</li>
                            <li><strong>Mídias enviadas (fotos, vídeos, áudios) e documentos de verificação:</strong> permanecem armazenados em infraestrutura segura mesmo após desativação do perfil, em conformidade com retenção de evidências para auditoria, requisições legais e prevenção de fraude. A exclusão definitiva pode ser solicitada conforme art. 18 da LGPD.</li>
                            <li><strong>Logs de segurança:</strong> 12 meses.</li>
                            <li><strong>Comunicações transacionais (e-mails enviados):</strong> 24 meses.</li>
                        </ul>
                    </Section>
                    ...
                    <Section n="11" title="Crianças e adolescentes">
                        <p>
                            O Privello é destinado <strong>exclusivamente a maiores de 18
                            ...
                            urgentemente em <a href="mailto:contato.privello@gmail.com" className="underline">contato.privello@gmail.com</a>.
                        </p>
                    </Section>
                    ...
                    <Section n="12" title="Alterações desta política">
                        <p>
                            ...
                            substanciais serão comunicadas com pelo menos <strong>30 dias de
                                antecedência</strong> por e-mail e por aviso na plataforma. A
                            versão vigente está sempre acessível nesta página com a data de
                            vigência atualizada no topo.
                        </p>
                    </Section>

                    <Section n="13" title="Encarregado / DPO">
                        <p>
                            Até a indicação de Encarregado formal, o canal de contato para
                            assuntos de proteção de dados é <a href="mailto:contato.privello@gmail.com" className="underline">contato.privello@gmail.com</a>. Você
                            também pode procurar diretamente a Autoridade Nacional de Proteção
                            de Dados (ANPD) em <a className="underline" href="https://www.gov.br/anpd" target="_blank" rel="noreferrer">gov.br/anpd</a>.
                        </p>
                    </Section>
                </div>
            </main>
