  ...
  if (IS_DEV) {
    return (
      <form action={devActivatePlan}>
        ...
        <button
          type="submit"
          className="block w-full rounded-xl border-2 border-dashed border-[#0a84ff]/40 bg-[#0a84ff]/[0.04] py-2.5 text-center text-[13px] font-semibold text-[#0a84ff] transition hover:bg-[#0a84ff]/[0.08] active:scale-[0.97]"
        >
          Ativar grátis (dev)
        </button>
      </form>
...
export function FreeBoostButton() {
  ...
  return (
    <button
      onClick={handleClick}
      disabled={pending}
      className="inline-flex items-center gap-2 rounded-xl bg-coral px-5 py-2.5 text-[13px] font-semibold text-white shadow-sm transition hover:brightness-110 active:scale-[0.97] disabled:opacity-50"
    >
